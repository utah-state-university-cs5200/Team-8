...
class LobbyWindow:
    ...
    def username(self):
        ...
        self.username_button = Button(self.username_frame, text="Change", command=self.username_change)
    ...
    def update_listbox(self):
        count = 1
        self.lobby_listbox.delete(1, END)
    ...
    def game_select(self, e):
        ...
        self.player_count_label_var.set(f"Players: {game['player_count']}")
